...
def validate_numero_telefone(phone_number):
    ...
    pattern = r"^\((\d{2,3})\) \d{5}-\d{4}$"
    # A função 're.match()' para verifica se o padrão definido corresponde ao número de telefone fornecido. O
    # 're.match()' retorna um objeto 'match' se houver correspondência no início da string, caso contrário,
    # retorna 'None'.
...
# TODO: Chame a função 'validate_numero_telefone()' com o número de telefone fornecido como argumento e armazene o
#  resultado retornado na variável 'result'.
